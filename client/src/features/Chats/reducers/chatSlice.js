...
export const chatSlice = createSlice({
  ...
  reducers: {
    ...
    receivedMessage: (state, action) => {
      ...
      let updateCurrentChat = false; // Flag to track if we need to update currentChatCopy

      console.log("chats", JSON.stringify(state.chats));
      const chatsCopy = state.chats.map((chat) => {
        if (message.chatId === chat.id) {
          ...
          if (message.chatId === currentChatCopy.id) {
            // Set the flag to true to indicate that we need to update currentChatCopy
      ...
      // Check if we need to update currentChatCopy
    ...
    createChat: (state, action) => {
      ...
      console.log("create chat", JSON.stringify(chat));

      // Update the state to include the new chat
      state.chats.push(chat);
      console.log("create chat", JSON.stringify(state.chats.length));
    },
